...
const CUES: Cue[] = [
  { start: 0.00,  end: 4.38,  text: "설문 결과로 의식 패턴을 AI가 분석하여 유형화합니다." },
  { start: 5.06,  end: 6.68,  text: "몰입도뿐 아닙니다." },
  { start: 6.78,  end: 9.48,  text: "만족도, 리더십, 조직 문화." },
  { start: 9.96,  end: 13.34, text: "영역 별로 타사와 비교하고 결과를 보고합니다." },
  { start: 13.94, end: 18.74, text: "리스크를 사전에 탐지하며, 이탈 위험군을 AI가 먼저 찾아냅니다." },
  { start: 19.56, end: 20.92, text: "그리고 What-If 시뮬레이터." },
  { start: 21.98, end: 27.24, text: "어느 영역을 어느 정도 개선하면 몰입도가 개선되는지 민감도 분석도 가능합니다." },
  { start: 27.24, end: 34.12, text: "이어지는 판 모듈과 함께 활용하면, 진단이 곧 실행과제와 연결됩니다." },
];
