...
// v20.1: 자막 가독성 — 긴 문장 의미 단위 줄바꿈 (사용자 검토 반영)
const CUES: Cue[] = [
  ...
  { start: 15.00, end: 19.98, text: "경영진 AI 에이전트는,\n전사 목표 달성수준을 모니터링하고 예측합니다." },
  { start: 21.30, end: 26.56, text: "모든 KPI를 실시간으로 모니터링하고\nAI가 실적을 추정하여 보고합니다." },
  { start: 27.44, end: 34.00, text: "HR 임원 AI 에이전트 기능 중 하나는\n보상 인상률 최적 배분입니다." },
  { start: 34.90, end: 39.02, text: "몰입 유형과 스킬 레벨,\n인사평가 등급과 번아웃 수준," },
  { start: 39.38, end: 44.50, text: "그리고 시장 임금까지.\nAI가 자동으로 크롤링해서 종합 판단합니다." },
  { start: 45.30, end: 51.92, text: "팀장 에이전트는 1대1 면담과 팀원 특성, 업무 현황을\nAI가 정리하여 팀장에게 보고합니다." },
];
